...
#Id Set
ids = set()
filePath = "./data/aurora-listing.csv"
...
'''
    ...
    Aurora Link (Modify number 1 part)
    link = "https://listing.ca/mls/?.3a.........1..$"
'''
#Write information to file
wfile = open(filePath, "a")
#File titles (Only be execute once)
if not file:
    wfile.write("Date,ID,Address,Street,Neighbourhood,City,Price,Bathroom,Bedroom,Link\n")
...
for pageIndex in range(1,500):
    ...
    link = "https://listing.ca/mls/?.3a........." + str(pageIndex) + "..$"
