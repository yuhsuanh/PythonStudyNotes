...
def getAreaPharmacies(basicUrl, listUri, filePath):
	print(filePath)
...
pharmaciesListUri = 'listServices.aspx?id=10345'
...
getAreaPharmacies(eriestclairhealthline, pharmaciesListUri, eriestclairFile)

# --- 2. South West Area ---
print('2. South West Area')
southwesthealthline = 'https://www.southwesthealthline.ca/'
southwestFile = '2. South West Area.csv'
getAreaPharmacies(southwesthealthline, pharmaciesListUri, southwestFile)
...
getAreaPharmacies(wwhealthline, pharmaciesListUri, wwFile)
...
getAreaPharmacies(hnhbhealthline, pharmaciesListUri, hnhbFile)

# --- 5. Central West Area ---
print('5. Central West Area')
centralwesthealthline = 'https://www.centralwesthealthline.ca/'
centralwestFile = '5. Central West Area.csv'
getAreaPharmacies(centralwesthealthline, pharmaciesListUri, centralwestFile)
...
getAreaPharmacies(mississaugahaltonhealthline, pharmaciesListUri, mississaugahaltonFile)
